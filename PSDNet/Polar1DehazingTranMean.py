...
class Dehaze(object):
    ...
    def t_matting(self, mask_out_np):
        refine_t = guidedFilter(self.image1.transpose(1, 2, 0).astype(np.float32),
                                mask_out_np[0].astype(np.float32), 30, 1e-4)#50,1e-4
        if self.clip:
...
def dehazing(opt):
    ...
    hazy_img1 = prepare_image('/opt/data/private/syj/code/PSDNet/data/0706/3-0.bmp')
    hazy_img2 = prepare_image('/opt/data/private/syj/code/PSDNet/data/0706/3-90.bmp')
    name1='76-3.jpg'
    name2='90.jpg'
